#! /bin/bash
cleos -u http://nodeos:8888 wallet create --file /tmp/wallet_password
cleos -u http://nodeos:8888 wallet open
...
cleos -u http://nodeos:8888 wallet import --private-key 5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3

# 5Jmsawgsp1tQ3GD6JyGCwy1dcvqKZgX6ugMVMdjirx85iv5VyPR <-> EOS7ijWCBmoXBi3CgtK7DJxentZZeTkeUnaSDvyro9dq7Sd1C3dC4
cleos -u http://nodeos:8888 wallet import --private-key 5Jmsawgsp1tQ3GD6JyGCwy1dcvqKZgX6ugMVMdjirx85iv5VyPR
...
cleos -u http://nodeos:8888 wallet import --private-key 5KhxKN8BFG5HewrcJFZvukXbs9KqDZyoKEX2ns1GbF5joNU4UCn
